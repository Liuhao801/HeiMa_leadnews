...
<head>
    ...
    <title>黑马头条</title>
    <!-- 引入样式文件 -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/vant/2.12.20/index.css">
    <!-- 页面样式 -->
...
<div id="app">
    <div class="article">
        ...
        <van-row type="flex" align="center" class="article-header">
            <van-col span="3">
                <van-image round class="article-avatar" src="http://43.137.8.13:9000/leadnews/1.jpg"></van-image>
            </van-col>
            <van-col span="16">
